...
> = {
  ...
  >;
  settings?: Resolver<
    Maybe<ResolversTypes['ChatSettings']>,
    ParentType,
    ContextType
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type ChatSettingsResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['ChatSettings'] = ResolversParentTypes['ChatSettings']
> = {
  testField?: Resolver<
...
export type MessageContentResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['MessageContent'] = ResolversParentTypes['MessageContent']
> = {
...
> = {
  ...
  createComment?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationCreateCommentArgs, 'postId' | 'content'>
  >;
  createDialog?: Resolver<
    ResolversTypes['Chat'],
    ParentType,
    ContextType,
    RequireFields<MutationCreateDialogArgs, 'input'>
  >;
  ...
  >;
  deleteChatById?: Resolver<
    ResolversTypes['Chat'],
    ParentType,
    ContextType,
    RequireFields<MutationDeleteChatByIdArgs, 'chatId'>
  >;
  deleteCommentById?: Resolver<
    ResolversTypes['Comment'],
    ParentType,
    ContextType,
    RequireFields<MutationDeleteCommentByIdArgs, 'id'>
  >;
  deleteMessageById?: Resolver<
    ResolversTypes['Message'],
    ParentType,
    ContextType,
    RequireFields<MutationDeleteMessageByIdArgs, 'messageId'>
  >;
  deletePostById?: Resolver<
    ResolversTypes['Post'],
    ParentType,
    ContextType,
    RequireFields<MutationDeletePostByIdArgs, 'postId'>
  >;
  editChatTitle?: Resolver<
    ResolversTypes['Chat'],
    ParentType,
    ContextType,
    RequireFields<MutationEditChatTitleArgs, 'input'>
  >;
  editComment?: Resolver<
    ResolversTypes['Comment'],
    ParentType,
    ContextType,
    RequireFields<MutationEditCommentArgs, 'commentId' | 'textContent'>
  >;
  editEmail?: Resolver<
    ResolversTypes['User'],
    ParentType,
    ContextType,
    RequireFields<MutationEditEmailArgs, 'newEmail'>
  >;
  editMessage?: Resolver<
    ResolversTypes['Message'],
    ParentType,
    ContextType,
    RequireFields<MutationEditMessageArgs, 'messageId' | 'newContent'>
  >;
  editPassword?: Resolver<
    ResolversTypes['User'],
    ParentType,
    ContextType,
    RequireFields<MutationEditPasswordArgs, 'input'>
  >;
  editPost?: Resolver<
    ResolversTypes['Post'],
    ParentType,
    ContextType,
    RequireFields<MutationEditPostArgs, 'postId'>
  >;
  editUsername?: Resolver<
    ResolversTypes['User'],
    ParentType,
    ContextType,
    RequireFields<MutationEditUsernameArgs, 'newFirstName' | 'newLastName'>
  >;
  ...
  markRead?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationMarkReadArgs, 'messageId'>
  >;
  removeFriend?: Resolver<
    Maybe<ResolversTypes['User']>,
    ParentType,
    ContextType,
    RequireFields<MutationRemoveFriendArgs, 'friendId'>
  >;
  toggleLike?: Resolver<
    ResolversTypes['Post'],
    ParentType,
...
> = {
  ...
  getFriendPosts?: Resolver<
    ...
    ContextType
  >;
  getMessageById?: Resolver<
    Maybe<ResolversTypes['Message']>,
    ParentType,
    ContextType,
    RequireFields<QueryGetMessageByIdArgs, 'messageId'>
  >;
  getPost?: Resolver<
  ...
  getUsers?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryGetUsersArgs, never>
  >;
...
> = {
  chatDeleted?: SubscriptionResolver<
    ResolversTypes['Chat'],
    'chatDeleted',
    ParentType,
    ContextType
  >;
  messageEdited?: SubscriptionResolver<
    ResolversTypes['Message'],
    'messageEdited',
    ParentType,
    ContextType,
    RequireFields<SubscriptionMessageEditedArgs, 'chatId'>
  >;
