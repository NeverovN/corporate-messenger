...
export type GetChatsQuery = { __typename?: 'Query' } & {
  ...
  >;
  getUser: { __typename?: 'User' } & Pick<User, 'id'>;
};
...
export type ChatFragmentFragment = { __typename?: 'Chat' } & Pick<
  Chat,
  'id' | 'createdAt' | 'isDialog' | 'title' | 'logo'
> & {
    participants: Array<
      Maybe<
        { __typename?: 'User' } & Pick<
      ...
      Array<
        Maybe<
          ...
          > & {
              ...
              >;
              readBy: Array<{ __typename?: 'User' } & Pick<User, 'id'>>;
            }
        >
      >
    >;
...
export type GetMessageByIdQuery = { __typename?: 'Query' } & {
  getMessageById?: Maybe<{ __typename?: 'Message' } & MessageFragmentFragment>;
};
...
export type UpdateChatLogoMutation = { __typename?: 'Mutation' } & {
  updateChatLogo: { __typename?: 'Chat' } & ChatFragmentFragment;
};
...
export type ClearHistoryMutation = { __typename?: 'Mutation' } & {
  clearChatHistory: { __typename?: 'Chat' } & Pick<Chat, 'id'>;
};
...
export type LeaveChatMutation = { __typename?: 'Mutation' } & {
  leaveChat: { __typename?: 'Chat' } & Pick<Chat, 'id'>;
};
...
export type MessageDeletedSubscription = { __typename?: 'Subscription' } & {
  messageDeleted: { __typename?: 'Message' } & MessageFragmentFragment;
};
...
export type EditCommentMutation = { __typename?: 'Mutation' } & {
  editComment: { __typename?: 'Comment' } & CommentFragmentFragment;
};
...
export type UpdateAvatarMutation = { __typename?: 'Mutation' } & {
  updateAvatar: { __typename?: 'User' } & UserFragmentFragment;
};
 ...
 * });
 */
export function useChatDeletedSubscription(
  baseOptions?: Apollo.SubscriptionHookOptions<
  ...
  return Apollo.useSubscription<
    ChatDeletedSubscription,
    ChatDeletedSubscriptionVariables
  >(ChatDeletedDocument, options);
}
export type ChatDeletedSubscriptionHookResult = ReturnType<
  typeof useChatDeletedSubscription
>;
...
export const UpdateChatLogoDocument = gql`
  ...
  ${ChatFragmentFragmentDoc}
`;
export type UpdateChatLogoMutationFn = Apollo.MutationFunction<
  UpdateChatLogoMutation,
  UpdateChatLogoMutationVariables
>;
 ...
 * });
 */
export function useUpdateChatLogoMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateChatLogoMutation,
    UpdateChatLogoMutationVariables
  >,
  ...
  return Apollo.useMutation<
    UpdateChatLogoMutation,
    UpdateChatLogoMutationVariables
  >(UpdateChatLogoDocument, options);
}
export type UpdateChatLogoMutationHookResult = ReturnType<
  typeof useUpdateChatLogoMutation
>;
export type UpdateChatLogoMutationResult = Apollo.MutationResult<UpdateChatLogoMutation>;
export type UpdateChatLogoMutationOptions = Apollo.BaseMutationOptions<
  UpdateChatLogoMutation,
  UpdateChatLogoMutationVariables
>;
...
`;
export type ClearHistoryMutationFn = Apollo.MutationFunction<
...
export function useClearHistoryMutation(
  ...
  return Apollo.useMutation<
    ClearHistoryMutation,
    ClearHistoryMutationVariables
  >(ClearHistoryDocument, options);
}
export type ClearHistoryMutationHookResult = ReturnType<
  typeof useClearHistoryMutation
>;
export type ClearHistoryMutationResult = Apollo.MutationResult<ClearHistoryMutation>;
export type ClearHistoryMutationOptions = Apollo.BaseMutationOptions<
  ClearHistoryMutation,
  ClearHistoryMutationVariables
>;
