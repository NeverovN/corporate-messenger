...
export type ChatDeletionSubscription = { __typename?: 'Subscription' } & {
  chatDeletion: { __typename?: 'Chat' } & ChatFragmentFragment;
};
 ...
 * });
 */
export function useChatDeletionSubscription(
  baseOptions?: Apollo.SubscriptionHookOptions<
    ChatDeletionSubscription,
    ChatDeletionSubscriptionVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useSubscription<
    ChatDeletionSubscription,
    ChatDeletionSubscriptionVariables
  >(ChatDeletionDocument, options);
}
export type ChatDeletionSubscriptionHookResult = ReturnType<
  typeof useChatDeletionSubscription
>;
