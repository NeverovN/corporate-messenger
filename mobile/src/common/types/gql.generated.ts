...
export type GetPostByIdQuery = { __typename?: 'Query' } & {
  getPost?: Maybe<
    { __typename?: 'Post' } & {
      comments?: Maybe<
        Array<{ __typename?: 'CommentModel' } & Pick<CommentModel, 'id'>>
      >;
    }
  >;
};
...
export type CreateCommentMutation = { __typename?: 'Mutation' } & {
  createComment: { __typename?: 'CommentModel' } & Pick<
    CommentModel,
    'id' | 'content' | 'createdAt'
  > & {
      author: { __typename?: 'User' } & Pick<
...
export type LikeCommentMutation = { __typename?: 'Mutation' } & {
  likeComment: { __typename?: 'CommentModel' } & CommentFragmentFragment;
};
...
export type GetCommentByIdQuery = { __typename?: 'Query' } & {
  getComment?: Maybe<{ __typename?: 'CommentModel' } & CommentFragmentFragment>;
};

export type CommentFragmentFragment = { __typename?: 'CommentModel' } & Pick<
  CommentModel,
  'id' | 'content' | 'createdAt'
> & {
    author: { __typename?: 'User' } & Pick<
